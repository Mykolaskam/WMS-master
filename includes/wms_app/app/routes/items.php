    ...
    if ($wrapper_sql->session_var_exists(session_id())) {
        ...
        return $this->view->render($response,
            ...
            [
                ...
                'all_items' => $all_items,
                'action_new_item' => '/wms/index.php/newitem',
...
$app->get('/newitem', function (Request $request, Response $response, $args) {
    ...
    if ($wrapper_sql->session_var_exists(session_id())) {
        ...
        return $this->view->render($response,
            ...
            [
                ...
                'action_create_item' => '/wms/index.php/newitem',
...
$app->post('/newitem', function (Request $request, Response $response, $args) {
    ...
    if ($wrapper_sql->session_var_exists(session_id())) {
        ...
        $wrapper_sql->create_new_item_var(
            $sanitised_item_name,
            $sanitised_sku,
